...
__conda_setup="$('/home/across/.dev/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/across/.dev/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/across/.dev/anaconda3/etc/profile.d/conda.sh"
    else
...
source /tmp/al/alacritty/extra/completions/alacritty.bash
